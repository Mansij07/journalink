...
export function ProjectCard({ project }: { project: ProjectWithProfessor }) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col gap-3 rounded-xl border border-border bg-card p-4 text-card-foreground transition-colors hover:border-foreground/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
      ...
      <h3 className="line-clamp-2 text-base font-semibold leading-snug tracking-[-0.01em] text-foreground">
        {project.title}
      </h3>
